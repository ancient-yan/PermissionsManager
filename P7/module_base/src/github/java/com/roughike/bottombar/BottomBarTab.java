...
public class BottomBarTab extends LinearLayout {
    ...
    public void setBadgeContent(String msg) {
        if (msg == null) {
            if (badge != null) {
    ...
    Bundle saveState() {
        ...
        outState.putString(STATE_BADGE_COUNT + getIndexInTabContainer(), badge.getText().toString());
        return outState;
    }
    ...
    void restoreState(Bundle savedInstanceState) {
        String previousBadge = savedInstanceState.getString(STATE_BADGE_COUNT + getIndexInTabContainer());
        setBadgeContent(previousBadge);
    }
